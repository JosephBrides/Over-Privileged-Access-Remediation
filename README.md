...
Azure Account: Free Azure account with an Entra ID tenant ([sign up here](https://azure.microsoft.com/freeმოჂVirtualization: VirtualBox or VMware Workstation (optional for local AD testing).

# Step-by-Step Setup

Create Azure Tenant and Test User:
